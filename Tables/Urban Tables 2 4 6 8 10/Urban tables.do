local folderpath "/Users/wyattwyatt/Documents/Study - Now/Summer Research/NEW/Urban Tables 2 4 6 8 10"
local filename "Urban tables"
local datapath "/Users/wyattwyatt/Documents/Study - Now/Summer Research/NEW/20240716 Urban Chip2018 and Instrumental Statistics and Inflation.dta"
...
*Step One: Variables and Data Processing (See Selmlog Urban Basics for more info)
...
***Table 2 with sequence: Two_tracks > Higher_edu Combined/Seperated > Gender(s), 2*2*3=12 columns in total.
...
outreg2 using "`xlspath'", replace ctitle(Sec Voc, All Gender, Non-specified Higheredu, Province Dum) pvalue addstat("Hettest: p-value", `het_p', "Hettest: df", `het_df')
drop m1 m2 m3
...
outreg2 [`estlist'] using "Table 2/Table2.xls", excel replace pvalue adjr2 drop(provincedum*) dec(3) sortvar(male exp expsqr higheredu) title("Table 2 (Sec Voc 1-6, Sec Gen 7-10; Non-specified 1-3 & 7-9, Specified 4-6 & 10-12; Genders repeat under for every 3 columns)") ctitle(" ") addnote("More notes") label
...
***Table 4 with sequence: Gaokao indicator / Parent indicator > Two_tracks > Higher_edu Combined/Seperated, 2*2*2=8 columns in total.
...
selmlog voc_log_monthlyearning  male exp expsqr higheredu TakeGaoKao provincedum2-provincedum15 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr higheredu TakeGaoKao provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
eststo
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu TakeGaoKao provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
eststo
...
selmlog gen_log_monthlyearning  male exp expsqr higheredu TakeGaoKao provincedum2-provincedum15 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr higheredu TakeGaoKao provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
eststo
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu TakeGaoKao provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
eststo
...
outreg2 [`estlist'] using "Table 4/Table4.xls", excel replace pvalue adjr2 drop(provincedum*) dec(3) sortvar(male exp expsqr higheredu) title("Table 4 (TakeGaokao 1-4, Parent indicators 5-8; Sec Voc 1-2, Sec Gen 3-4; Non-specified 1 3 Specified 2 4)") ctitle(" ") addnote("More notes") label
...
***Table 6 with sequence: Unemployment types (A20=5 or A20=5|9) > Two_tracks > Higher_edu Combined/Seperated, 2*2*2=8 columns in total.
...
outreg2 [`estlist'] using "Table 6/Table6.xls", excel replace pvalue adjr2 drop(provincedum*) dec(3) sortvar(male exp expsqr higheredu) title("Table 6 (Unemployment A20=5 1-4 A20=5|9 5-8; Sec Voc 1-2 5-6, Sec Gen 3-4 7-8; Non-specified 1 3 5 7 Specified 2 4 6 8)") ctitle(" ") addnote("More notes") label




***Table 8 with sequence: Occupytion or Contract > Two_tracks > Higher_edu Combined/Seperated, 2*2*2=8 columns in total.
...
outreg2 [`estlist'] using "Table 8/Table8.xls", excel replace pvalue adjr2 drop(provincedum*) dec(3) sortvar(male exp expsqr higheredu) title("Table 8 (Occupation 1-4 High contract 5-8; Sec Voc 1-2 5-6, Sec Gen 3-4 7-8; Non-specified 1 3 5 7 Specified 2 4 6 8)") ctitle(" ") addnote("More notes") label 


***Table 10 with sequence: Sec Voc or Sec Gen, 2 columns.
...
outreg2 [`estlist'] using "Table 10/Table10.xls", excel replace pvalue adjr2 drop(provincedum*) dec(3) sortvar(male exp expsqr higheredu) title("Table 10") ctitle(" ") addnote("More notes") label
