local folderpath "/Users/wyattwyatt/Downloads/Revision Code/Wyatt/RDD/Higheredu/FuzzyOption Male controlled/Rural"
local filename "Rural 1979 Higheredu FuzzyOption Male controlled"
...
**2_1_1_1 Pooled 
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
...
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_1_3 SecVoc
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_1_4 SecGen
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_2_1 Pooled 
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_2_3 SecVoc
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_2_4 SecGen
*One year each
rdrobust log_monthlyearning t if inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_3_1 Pooled 
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_3_3 SecVoc
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_3_4 SecGen
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_4_1 Pooled 
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_4_3 SecVoc
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_4_4 SecGen
*One year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-2 | t>=1) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_5_1 Pooled 
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_5_3 SecVoc
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_5_4 SecGen
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_6_1 Pooled 
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & educat != ., covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & (educat==1 | educat==2), covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_6_3 SecVoc
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & educat ==1, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
...
**2_1_6_4 SecGen
*One year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -12, 11) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(12) all vce(nncluster province_code)
...
*Three year each
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(t, -36, 35) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(uni) p(1) h(36) all vce(nncluster province_code)
...
*Automatic
rdrobust log_monthlyearning t if (t<=-3 | t>=2) & inrange(monthlyearning, 200, 16667) & educat ==2, covs(male) fuzzy(higheredu) kernel(epa) p(1) bwselect(mserd) all vce(nncluster province_code)
local bandwidth = e(h_l)
mata : st_numscalar("e(N)", `e(N_h_l)'+`e(N_h_r)')
