...
local filename "Selmlog Rural Basics birthyear interact"
local datapath "/Users/dhare/Desktop/trying do files/20240716 Rural Chip2018 and Instrumental Statistics and Inflation.dta"
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning male exp expsqr higheredu highereduafter79 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress voc_log_monthlyearning male exp expsqr higheredu highereduafter79 provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning male exp expsqr higheredu highereduafter79 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress gen_log_monthlyearning male exp expsqr higheredu highereduafter79 provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
...
qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr higheredu highereduafter79 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu highereduafter79 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
selmlog voc_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
...
qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr higheredu highereduafter79 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu highereduafter79 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr higheredu highereduafter79 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu highereduafter79 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu highvocafter79 highgenafter79 adulteduafter79 m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr higheredu highereduafter79 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu highereduafter79 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
selmlog gen_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu highereduafter79 provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr higheredu highereduafter79 m1 m2 m3 if e(sample)
