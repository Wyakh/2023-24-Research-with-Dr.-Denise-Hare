local folderpath "/Users/wyattwyatt/Downloads/Revision Code/Aiden/New Selmlog/Basic Selmlog/Urban"
local filename "Selmlog Urban Basics"
...
selmlog voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning male exp expsqr higheredu if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
selmlog voc_log_monthlyearning male exp expsqr higheredu provincedum2-provincedum15 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr higheredu provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning male exp expsqr higheredu if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
selmlog gen_log_monthlyearning male exp expsqr higheredu provincedum2-provincedum15 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr higheredu provincedum2-provincedum15 m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr higheredu if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
selmlog voc_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr higheredu m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
qui regress voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr higheredu if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if e(sample)
...
selmlog voc_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum voc_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr higheredu if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 m1 m2 m3 if male==1 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning male exp expsqr higheredu m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr highvocedu highgenedu adultedu m1 m2 m3 if e(sample)
...
selmlog gen_log_monthlyearning exp expsqr higheredu if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
...
selmlog gen_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning exp expsqr higheredu provincedum2-provincedum15 m1 m2 m3 if male==0 & inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 250, 25000)
estat hettest
local het_p = r(p)
local het_df = r(df)
sum gen_log_monthlyearning exp expsqr higheredu m1 m2 m3 if e(sample)
