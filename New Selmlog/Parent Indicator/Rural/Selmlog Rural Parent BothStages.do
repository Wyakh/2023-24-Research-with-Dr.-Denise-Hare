...
local logname "Selmlog Rural Parent BothStages"
...
selmlog voc_log_monthlyearning  male exp expsqr higheredu parent_partymember if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative  parent_partymember ) dmf(2) showmlogit gen(m)
...
selmlog gen_log_monthlyearning  male exp expsqr higheredu parent_partymember if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative  parent_partymember ) dmf(2) showmlogit gen(m)
