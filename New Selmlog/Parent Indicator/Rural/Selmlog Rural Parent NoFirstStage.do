local folderpath "/Users/wyattwyatt/Downloads/Revision Code/Aiden/New Selmlog/Parent Indicator/Rural"
local logname "Selmlog Rural Parent NoFirstStage"
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
sum voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog voc_log_monthlyearning  male exp expsqr higheredu parent_secedu parent_highedu if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
sum voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog gen_log_monthlyearning  male exp expsqr higheredu parent_secedu parent_highedu if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog voc_log_monthlyearning  male exp expsqr highvocedu highgenedu adultedu parent_partymember if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog voc_log_monthlyearning  male exp expsqr higheredu parent_partymember if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr higheredu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog voc_log_monthlyearning  male exp expsqr higheredu parent_partymember provincedum2-provincedum15 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress voc_log_monthlyearning male exp expsqr higheredu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog gen_log_monthlyearning  male exp expsqr highvocedu highgenedu adultedu parent_partymember if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
sum voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_partymember m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog gen_log_monthlyearning  male exp expsqr higheredu parent_partymember if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr higheredu parent_partymember  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
selmlog gen_log_monthlyearning  male exp expsqr higheredu parent_partymember provincedum2-provincedum15 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667), sel(educat=male exp expsqr ins1_secgen_entrant_relative ins2_highedu_entrant_relative ins3_vs_entrant_relative) dmf(2) showmlogit gen(m)

qui regress gen_log_monthlyearning male exp expsqr higheredu parent_partymember provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember Keyschool m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember Keyschool provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember Keyschool m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress voc_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember Keyschool provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember Keyschool m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
sum voc_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember Keyschool m1 m2 m3 if e(sample)
...
qui regress gen_log_monthlyearning male exp expsqr highvocedu highgenedu adultedu parent_secedu parent_highedu parent_partymember Keyschool provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember Keyschool m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
...
qui regress gen_log_monthlyearning male exp expsqr higheredu parent_secedu parent_highedu parent_partymember Keyschool provincedum2-provincedum15  m1 m2 m3 if inrange(birthyear, 1971, 1992) & inrange(monthlyearning, 200, 16667)
